...
namespace PHONES_MARKETE.Controllers
{
    public class OrderController : Controller
    {
        ...
        public OrderController(IItems itemservice, UserManager<MyApplicationUser> userManager,
        ...
        {
            //save order need cart as parametet
            //we get shopping cart from cookies 
            string sesstionCart = string.Empty;
            if (HttpContext.Request.Cookies["Cart"] != null)
                sesstionCart = HttpContext.Request.Cookies["Cart"];
            var cart = JsonConvert.DeserializeObject<ShoppingCart>(sesstionCart);
